--★異能殺し 天魔･宿儺
function c114100178.initial_effect(c)
	--synchro summon
	...
	e1:SetCondition(c114100178.adcon)
	e1:SetOperation(c114100178.adop)
	c:RegisterEffect(e1)
	--disable
	...
	e2:SetCondition(c114100178.discon)
	e2:SetOperation(c114100178.disop)
	c:RegisterEffect(e2)
end
function c114100178.adcon(e,tp,eg,ep,ev,re,r,rp)
	return Duel.GetAttackTarget()~=nil
end
function c114100178.adop(e,tp,eg,ep,ev,re,r,rp)
...
function c114100178.discon(e,tp,eg,ep,ev,re,r,rp)
...
function c114100178.disop(e,tp,eg,ep,ev,re,r,rp)
