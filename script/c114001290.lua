...
function c114001290.initial_effect(c)
	...
	e2:SetTarget(c114001290.target)
	e2:SetOperation(c114001290.operation)
	c:RegisterEffect(e2)
end
function c114001290.regop(e,tp,eg,ep,ev,re,r,rp)
	...
	e1:SetOperation(c114001290.operation)
...
function c114001290.checkatt(tp)
	return Duel.IsExistingMatchingCard(c114001290.tgfilter,tp,LOCATION_DECK,0,1,nil,ATTRIBUTE_EARTH)
	and Duel.IsExistingMatchingCard(c114001290.tgfilter,tp,LOCATION_DECK,0,1,nil,ATTRIBUTE_WATER)
	and Duel.IsExistingMatchingCard(c114001290.tgfilter,tp,LOCATION_DECK,0,1,nil,ATTRIBUTE_FIRE)
	and Duel.IsExistingMatchingCard(c114001290.tgfilter,tp,LOCATION_DECK,0,1,nil,ATTRIBUTE_WIND)
end
...
function c114001290.activate(e,tp,eg,ep,ev,re,r,rp)
	if c114001290.checkatt(tp) then
		local g1=Duel.GetMatchingGroup(c114001290.tgfilter,tp,LOCATION_DECK,0,nil,ATTRIBUTE_EARTH)
		local g2=Duel.GetMatchingGroup(c114001290.tgfilter,tp,LOCATION_DECK,0,nil,ATTRIBUTE_WATER)
		local g3=Duel.GetMatchingGroup(c114001290.tgfilter,tp,LOCATION_DECK,0,nil,ATTRIBUTE_FIRE)
		local g4=Duel.GetMatchingGroup(c114001290.tgfilter,tp,LOCATION_DECK,0,nil,ATTRIBUTE_WIND)
		g1:Merge(g2)
		g1:Merge(g3)
		g1:Merge(g4)
...
function c114001290.operation(e,tp,eg,ep,ev,re,r,rp)
